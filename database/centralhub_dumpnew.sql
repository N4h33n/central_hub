...
INSERT INTO `ADMIN` VALUES ('00000001','');
...
CREATE TABLE `COURSE_PREREQS` (
  ...
  UNIQUE KEY `prereq_UNIQUE` (`prereq`),
...
INSERT INTO `FACULTY` VALUES ('00000001','naheenkabir@gmail.com','Naheen Kabir',NULL);
...
--
-- Table structure for table `STYDENT_PARTICIPATESIN_RESEARCH`
--

DROP TABLE IF EXISTS `STYDENT_PARTICIPATESIN_RESEARCH`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `STYDENT_PARTICIPATESIN_RESEARCH` (
  `s_ucid` varchar(10) NOT NULL,
  `researchid` varchar(10) NOT NULL,
  `datejoined` date NOT NULL,
...
--
-- Dumping data for table `STYDENT_PARTICIPATESIN_RESEARCH`
--

LOCK TABLES `STYDENT_PARTICIPATESIN_RESEARCH` WRITE;
/*!40000 ALTER TABLE `STYDENT_PARTICIPATESIN_RESEARCH` DISABLE KEYS */;
/*!40000 ALTER TABLE `STYDENT_PARTICIPATESIN_RESEARCH` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-11-29 14:38:50
